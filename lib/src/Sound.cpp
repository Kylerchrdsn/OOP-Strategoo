...
bool Sound::loadSounds()
{
	...
	menuTheme = Mix_LoadMUS("lib/sounds/strategOO_Game_Theme.wav");
	gameTheme = Mix_LoadMUS("lib/sounds/strategOO_Game_Theme.wav");
	winTheme = Mix_LoadMUS("lib/sounds/winMusic.wav");
	loseTheme = Mix_LoadMUS("lib/sounds/loseMusic.wav");
	...
	battleSound = Mix_LoadWAV("lib/sounds/battleSound.wav");
	bombExplosion = Mix_LoadWAV("lib/sounds/explosion.wav");
	buttonPress = Mix_LoadWAV("lib/sounds/buttonPress.wav");
	moveSelector = Mix_LoadWAV("lib/sounds/selectorMove.wav");
	selectPiece = Mix_LoadWAV("lib/sounds/pieceSelect.wav");
	placePiece = Mix_LoadWAV("lib/sounds/piecePlace.wav");

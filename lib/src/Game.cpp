...
bool Game::initialize()
{
	...
	buttons[2] = new PieceButton(0, 100, 8, "lib/images/colonelbutton.png");
	buttons[3] = new PieceButton(0, 550, 12, "lib/images/flagbutton.png");
	buttons[4] = new PieceButton(0, 50, 9, "lib/images/generalbutton.png");
	buttons[5] = new PieceButton(0, 250, 5, "lib/images/lieutenantbutton.png");
	buttons[6] = new PieceButton(0, 150, 7, "lib/images/majorbutton.png");
	buttons[7] = new PieceButton(0, 0, 10, "lib/images/marshalbutton.png");
	buttons[8] = new PieceButton(0, 350, 3, "lib/images/minerbutton.png");
...
void Game::updatePlayByPlay(Piece* const first, Piece* const second, const int mover, const int winner) const{
	...
	if(mover == 0){
		...
		if(winner == -1){
			ss << "draws with";
		}else if(winner == 0){ //if player won
		...
		else if(winner == 1){ //if computer won
			if(second->getRank() == 12){
				ss << "captures";
			}else if(second->getRank() == 11){
				ss << "defuses";
